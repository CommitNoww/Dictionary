...
import LexicalInfoPage from "./pages/LexicalInfoPage";
import SearchByInitialPage from "./pages/SearchByInitialPage"; // 새로 추가한 페이지
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route 
          path="/lexical-info" 
          element={<LexicalInfoPage userInfo={userInfo} onLogout={handleLogout} />} 
        />
        <Route 
          path="/search-by-initial" 
          element={<SearchByInitialPage userInfo={userInfo} onLogout={handleLogout} />}
        />
      </Routes>
    </Router>
  );
